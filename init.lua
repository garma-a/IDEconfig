...
-- Helper function to determine current working directory
...
local function toggle_harpoon_terminal(term_num)
	...
	-- Jump to the terminal natively
	if not harpoon_term_bufs[term_num] or not vim.api.nvim_buf_is_valid(harpoon_term_bufs[term_num]) then
		-- Create a new terminal buffer
		vim.cmd("enew")
		
		-- Set working directory inside terminal before opening it
		...
		vim.api.nvim_set_current_buf(harpoon_term_bufs[term_num])
	end
